...
<div class="main-header">
    ...
    <p>Tác giả: Ma Vĩnh Anh - Trường  Tiểu học Minh Dân - ĐT: 0862262886</p>
</div>
""", unsafe_allow_html=True)
...
# --- CHÂN TRANG ---
st.markdown("---")
st.markdown("<div style='text-align: center; color: #666;'>© 2025 - Ma Vĩnh Anh - Trường Tiểu học Minh Dân - ĐT: 0862262886</div>", unsafe_allow_html=True)
